    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="folder-git-2" href="{{ route('admin.boxes') }}" :current="request()->routeIs('admin.boxes*') || request()->routeIs('admin.items*')">
                    Boxes
                </flux:navbar.item>
                <flux:navbar.item icon="credit-card" href="{{ route('admin.deposits') }}" :current="request()->routeIs('admin.deposits') || request()->routeIs('admin.payment-settings*')">
                    Deposits
                </flux:navbar.item>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="Platform">
                    ...
                    <flux:navlist.item icon="folder-git-2" href="{{ route('admin.boxes') }}" :current="request()->routeIs('admin.boxes*') || request()->routeIs('admin.items*')">
                        Boxes
                    </flux:navlist.item>
                    <flux:navlist.item icon="credit-card" href="{{ route('admin.deposits') }}" :current="request()->routeIs('admin.deposits') || request()->routeIs('admin.payment-settings*')">
                        Deposits
                    </flux:navlist.item>
